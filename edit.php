...
<content>
   <form method="post" action="aksi/aksi1.php">
  ...
  <div class="form-group">
    <label for="exampleInputEmail1">Masukan Nilai Data</label>
    <input name="data" type="number" class="form-control" placeholder="1.0000" step="0.00001" min="0" max="1000" required="">
  </div>
  <button type="submit" value="Submit" name="Submit" class="btn btn-primary btn-lg btn-block">Edit</button>
</form>
</content>
