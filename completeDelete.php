...
<body>
<div style="margin: 10px; margin-right: 30%;" class=" alert alert-success" role="alert">
...
<div class="container" style="background: #ababab; z-index: 0; height: 100%; padding: 10px 10px 0 10px;">
